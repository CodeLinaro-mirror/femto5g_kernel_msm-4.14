...
static int ap130x_init_state(struct v4l2_subdev *sd,
			     struct v4l2_subdev_state *state)
{
...
static const struct v4l2_subdev_internal_ops ap130x_internal_ops = {
	.init_state = ap130x_init_state,
};
...
static int ap130x_sensor_init(struct ap130x_sensor *sensor, unsigned int index)
{
	...
	sd->internal_ops = &ap130x_internal_ops;
