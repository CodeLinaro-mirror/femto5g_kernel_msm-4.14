...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_dl_server_stop_skip);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_fair_dl_server_start);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_task_tick_scx);
